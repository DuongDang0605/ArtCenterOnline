// Migrations/20250905025657_DropMainTeacherId_EnforceScheduleTeacher.cs
...
namespace ArtCenterOnline.Server.Migrations
{
    public partial class DropMainTeacherId_EnforceScheduleTeacher : Migration
    {
        ...
        {
            // 1) Backfill Schedule.TeacherId từ Class.MainTeacherId (nếu còn)
...
");
            ...
            // 4) Drop FK/Index liên quan MainTeacherId (nếu có) + drop cột
            migrationBuilder.Sql(@"

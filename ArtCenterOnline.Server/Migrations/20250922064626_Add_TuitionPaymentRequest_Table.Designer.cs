...
namespace ArtCenterOnline.Server.Migrations
{
    ...
    [Migration("20250922064626_Add_TuitionPaymentRequest_Table")]
    partial class Add_TuitionPaymentRequest_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtCenterOnline.Server.Model.Entities.AuthLoginLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("Role", "DateLocal");

                    b.HasIndex("UserId", "DateLocal");

                    b.ToTable("AuthLoginLogs", (string)null);
                });

            modelBuilder.Entity("ArtCenterOnline.Server.Model.Entities.TuitionPaymentRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TuitionPaymentRequests", (string)null);
                });

            modelBuilder.Entity("ArtCenterOnline.Server.Model.Entities.WebRequestLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Path", "DateLocal");

                    b.ToTable("WebRequestLogs", (string)null);
                });

            modelBuilder.Entity("ArtCenterOnline.Server.Model.Entities.WebTrafficDaily", b =>
                {
                    ...
                    b.ToTable("WebTrafficDaily", (string)null);
                });

            modelBuilder.Entity("ArtCenterOnline.Server.Model.Entities.WebTrafficMonthly", b =>
                {
                    b.Property<int>("Year")
                        .HasColumnType("int");
                    ...
                    b.HasKey("Year", "Month", "Path");

                    b.HasIndex("Year", "Month");

                    b.ToTable("WebTrafficMonthly", (string)null);
                });

            modelBuilder.Entity("ArtCenterOnline.Server.Model.PasswordResetOtp", b =>
                {
